...
const en = {
  ...
  vaults: "Vaults…",
  vaultsTitle: "Vaults",
  vaultsManage: "Manage Vaults…",
  vaultsEmpty: "No vaults yet - open a folder to get started.",
  vaultsOpen: "Open",
  vaultsForget: "Forget",
  vaultsPin: "Set as default",
  recent: "Recent",
  basePickerTitle: "Open Database…",
  basePickerEmpty: "No .base files found in this vault. Create a `.base` file to define a database view.",
  baseBack: "Back",
  baseTitleCol: "File",
  baseFilter: "filter…",
  baseEmpty: "No rows match the current filters.",
  baseOpenCommand: "Open Database…",
  slideshowCommand: "Start Slideshow",
  slidesHint: "to navigate",
  slidesExit: "to exit",
  libraryHome: "Library Home",
  librarySearch: "Filter documents…",
  libraryAllFolders: "All folders",
  libraryEmpty: "No documents yet.",
  libraryIndexing: "Building document index…",
  ...
  containerTitle: "In this folder",
  containerEmpty: "No other notes yet.",
...
const zh: typeof en = {
  ...
  vaultsTitle: "知识库",
  vaultsManage: "管理知识库…",
  vaultsEmpty: "还没有知识库——打开一个文件夹开始使用。",
  vaultsOpen: "打开",
  vaultsForget: "移除",
  vaultsPin: "设为默认",
  recent: "最近打开",
  basePickerTitle: "打开数据库…",
  basePickerEmpty: "此 vault 中没有 .base 文件。请创建一个 .base 文件定义数据库视图。",
  baseBack: "返回",
  baseTitleCol: "文件",
  baseFilter: "筛选…",
  baseEmpty: "没有匹配当前筛选条件的行。",
  baseOpenCommand: "打开数据库…",
  slideshowCommand: "开始幻灯片放映",
  slidesHint: "切换",
  slidesExit: "退出",
  libraryHome: "知识库首页",
  librarySearch: "筛选文档…",
  libraryAllFolders: "全部文件夹",
  libraryEmpty: "还没有文档。",
  libraryIndexing: "正在建立文档索引…",
  saveAsExport: "另存为 / 导出",
  today: "今天",
  yesterday: "昨天",
  daysAgo: (n: number) => `${n} 天前`,
  wordsUnit: (n: number) => `${n} 字`,
  viewAsTable: "以表格查看",
  ...
  containerTitle: "本文件夹内容",
  containerEmpty: "暂无其他笔记。",
  ctxNewNamePrompt: "名称：",
  ctxRenamePrompt: "新名称：",
